              ...
              {store && (
                <div className={StoreStyle.storeMarkStoreContainer}>
                  ...
                  <div className='flex'>
                    ...
                    <div className={StoreStyle.storeMarkStoreAddressWaze}><a className={StoreStyle.storeMarkStoreAddressWazeLink} target='_blank' href={store?.waze}>Abrir en Waze</a></div>
                  </div>
                  ...
                  <div className={StoreStyle.storeMarkStoreSchedule}>{store?.schedule}</div>
